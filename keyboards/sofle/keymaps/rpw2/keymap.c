 ...
 */
	...
	[_QWERTY] = LAYOUT( \
	  ...
	  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, _______,    _______,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT, \
			 KC_LGUI,KC_LALT,KC_LCTRL, MO(_L1), KC_ENT,         KC_SPC,  MO(_L2), KC_ENT, KC_LBRC, KC_RBRC \
	),
	...
	[_L2] = LAYOUT( \
	  ...
	  KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,     _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, KC_TILD,
			   _______, _______, _______, _______, _______,     KC_BSPC, _______, _______, _______, CG_TOGG \
	),
};
